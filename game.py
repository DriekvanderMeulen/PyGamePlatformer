...
class Player(pygame.sprite.Sprite):
    ...
    def loop(self, fps):
        ...
        if self.rect.top > HEIGHT:  # Check if fallen below the screen
            reset_game()
...
def main(window):
    ...
    objects = [
        ...
        Block(block_size * 39, HEIGHT - block_size * 1, block_size),
        ...
        Block(block_size * 51, HEIGHT - block_size * 1, block_size),
        Block(block_size * 51, HEIGHT - block_size * 2, block_size),
        Block(block_size * 51, HEIGHT - block_size * 3, block_size),
        ...
        Block(block_size * 53, HEIGHT - block_size * 1, block_size),
